...
│
├── spam.csv                             # Original text dataset
├── spam-sms-detection.ipynb             # Full Notebook (EDA, text preprocessing, modeling)
├── train_model.py                       # Script to retrain and save production model
├── model.pkl                            # Serialized trained model (Pickle)
├── vectorizer.pkl                       # Serialized TF-IDF vectorizer (Pickle)
├── app.py                               # Streamlit App entry point
├── main.py                              # Additional model utilities
├── requirements.txt                     # All python dependencies
├── nltk.txt                             # NLTK requirements for cloud deployments
